#
# Lighthouse Audio Files
#

ALARM_PATH := vendor/lighthouse/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/lighthouse/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/lighthouse/prebuilt/common/media/audio/ringtones
...
PRODUCT_COPY_FILES += \
    ...
    $(RINGTONE_PATH)/GTA-SA-THEME.ogg:$(TARGET_COPY_OUT_PRODUCT)/media/audio/ringtones/GTA-SA-THEME.ogg
