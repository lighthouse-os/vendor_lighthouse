...
PRODUCT_COPY_FILES += \
    ...
    vendor/lighthouse/config/permissions/privapp-permissions-fonts-system_ext.xml:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/permissions/privapp-permissions-fonts-system_ext.xml
