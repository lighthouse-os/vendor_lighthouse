...
cur_dir=`pwd`
flashable_zip_template="$ANDROID_BUILD_TOP/vendor/lighthouse/build/tools/overlays_zip_template"
overlays_path_top="$ANDROID_BUILD_TOP/vendor/lighthouse/overlay/themes/"
overlays_path_temp="$ANDROID_BUILD_TOP/overlays_temp"
overlays_zip_name="lighthouse_overlays.zip"
