...
if __name__ == '__main__':
    default_gerrit = 'https://review.lighthouseos.net'
    ...
    for project in projects:
        name = ("LighthouseOS/")+project.get('name')
    ...
    for item in mergables:
        ...
        if args.gerrit == default_gerrit:
            ...
            if args.pull:
                cmd = ['git pull --no-edit lighthouse', item['fetch'][method]['ref']]
            else:
                cmd = ['git fetch lighthouse', item['fetch'][method]['ref']]
            if args.quiet:
                cmd.append('--quiet')
            else:
                print(cmd)
